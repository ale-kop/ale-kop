...
class User extends Authenticatable
{
    ...
    public function grantCourseAccess(Course $course, string $source = 'manual'): CourseAccess
    {
        return $this->courseAccesses()->updateOrCreate(
            [
                'scope' => 'course',
                'course_id' => $course->id,
            ],
    ...
    public function grantFullCourseAccess(string $source = 'manual'): CourseAccess
    {
        return $this->courseAccesses()->updateOrCreate(
            [
                'scope' => 'full',
