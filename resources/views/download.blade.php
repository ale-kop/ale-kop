    ...
    <div class="w-full max-w-xl text-center">
        ...
        <div id="newsletter-card"
            ...
            <form action="{{ route('newsletter.subscribe') }}" method="POST"
                ...
                <div>
                    <x-forms.label for="nl_name_dl">Nome</x-forms.label>
                    <x-forms.input type="text" name="name" id="nl_name_dl"
                                   placeholder="Seu nome" class="w-full" />
                </div>

                <div>
                    <x-forms.label for="nl_email_dl">
                        E-mail <span class="text-accent font-bold">*</span>
                    </x-forms.label>
                    <x-forms.input type="email" name="email" id="nl_email_dl"
